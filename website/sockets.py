...
from website.game_code import computer_message, handle_hangman, handle_normal_mode, handle_scramble_mode, hangman_stop, scramble_timer_done, start_scramble, startHangman
